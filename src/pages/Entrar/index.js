...
export default function Entrar() {
  ...
  return (
    <View style={estilos.container}>
      ...
      {/* Animate text container with fade-in effect, keeping it at initial position */}
      <Animated.View
        style={{
      ...
      >
        <View style={estilos.espaco2}>
          ...
          <View style={{ flexDirection: 'row', width: '100%', height: '100%', paddingTop: 10, gap: 2 }}>
            <TouchableOpacity style={estilos.btnLogin} onPress={AcessarLogin}>
              <Text style={estilos.text2}>LOGIN</Text>
            </TouchableOpacity>

            <TouchableOpacity style={estilos.btnLogin} onPress={AcessarCadastrar}>
              <Text style={estilos.text2}>CADASTRAR</Text>
            </TouchableOpacity>
          </View>
        </View>
      </Animated.View>
